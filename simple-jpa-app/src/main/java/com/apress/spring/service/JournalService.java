...
public class JournalService {
	...
	public void insertData() throws ParseException {
		...
		repo.save(new Journal("스프링 부트 해부", "스프링 부트를 자세히 살펴 보았다", "02/01/2016"));
		repo.save(new Journal("스프링 부트 클라우드", "클라우드 파운드리를 응용한 스프링 부트를 공부했다", "03/01/2016"));
		repo.save(new Journal("간단한 스프링 부트 프로젝트", "스프링 부트 프로젝트를 처음 만들어보았다", "01/01/2016"));
		log.info("> 완료");
	}
	...
	public List<Journal> findCustom(String word) {
